"""
Plotting c and z vs PCA1 of het and mean env cond This script implements a quick
and dirty solution where a linear model is fitted on c and z, instead of
calculating contriutions of features directly.
"""
