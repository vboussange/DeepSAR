...
# TODO
This is still to be implemented, for now this script is a copy of Ridge_c_vs_z
"""
...
def get_Xy(gdf, climate_predictors, feature_scaler=None, target_scaler=None):
    ...
    X_area = df_features[["log_area"]]
    X_climate = df_features[climate_predictors]
...
def compute_coeff_importance(res, climate_predictors):
    """
...
def plot_intercept_vs_slope(intercepts, slopes):
    """
    Plots the estimated intercepts against the estimated slopes.

    Args:
        intercepts (np.ndarray): Estimated intercepts.
        slopes (np.ndarray): Estimated slopes.
    """
