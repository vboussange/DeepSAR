...
from src.NNNegExpSAR import NNNegExpSAR
from src.utils import save_to_pickle

import sys
from pathlib import Path
sys.path.append(str(Path(__file__).parent / Path("../../../scripts/NNNegExpSAR/")))
import NNNegExpSAR_fit_simple
from NNNegExpSAR_fit_simple import CONFIG
...
if __name__ == "__main__":
    ...
    X, y, feature_scaler, target_scaler = NNNegExpSAR_fit_simple.get_Xy_scaled(gdf_test, climate_predictors, feature_scaler=feature_scaler,  target_scaler=target_scaler)
    ...
    ax.legend()
    ax.set_yscale("log")
    ax.set_title(f"NNNegExpSAR regression, RMSE={root_mean_squared_error(gdf_test["sr"], sr_pred)}")
    fig.savefig("NNNegExpSAR.png")
