...
\begin{tikzpicture}[
    ...
    \node (lc) at(-1, 3.5) {\includegraphics[width=6.2cm]{../panels/landcover_real.png}};

    \node[mynodeorange, minimum height=13.5cm, minimum width=7.6cm] (box) at (-1.8, -6.8) {};
    \node[] (box_text) at (-2., -0.5) {Raw environmental data};
    \node (cl1) at (-1.8, -4.0) {\includegraphics[width=7.8cm]{../panels/chelsa_real_bio1.png}};
    \node (cl2) at (-1, -7.25) {$\vdots$};
    \node (cl3) at (-1.8, -10.5) {\includegraphics[width=7.8cm]{../panels/chelsa_real_bio4.png}};
