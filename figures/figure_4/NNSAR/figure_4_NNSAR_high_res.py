...
fig_mean_run.savefig("mean_run_c_z_sr_coarsening_hig_res.png", transparent=True, dpi=300)
fig_mean_run.savefig("std_run_c_z_sr_coarsening_hig_res.png", transparent=True, dpi=300)
