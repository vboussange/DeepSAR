...
class MLP(nn.Module):
    def __init__(self, input_dim):
        ...
        self.nn = SimpleNNBatchNorm(input_dim, 1)
...
class CustomMSELoss(nn.Module):
    ...
    def forward(self, predictions, input_features, targets):
        ...
        try:
            ...
            print("problem with grad eval")
            loss_grad = 0
        # print(f"loss MSE: {loss_mse:.4f} | loss deriv: {loss_grad:.4f}")
