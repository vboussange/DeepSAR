...
def train_and_evaluate(model, gdf_full, predictors, criterion, optimizer, scheduler, config):
...
if __name__ == '__main__':
    ...
    results= train_and_evaluate(model, gdf, predictors, criterion, optimizer, scheduler, config)
